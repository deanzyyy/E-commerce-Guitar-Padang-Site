...
export default function EditProductPage() {
  ...
  const [category, setCategory] = useState("ACOUSTIC");
  ...
  return (
    <div className="bg-white w-full min-h-screen">
      ...
      <h1 className="text-3xl text-black m-10">Edit Produk</h1>
          ...
          <div className="m-10 flex flex-row space-x-10">
            ...
            <div className="w-1/2">
              ...
              <label>
                ...
                <select
                  className="border border-black bg-white text-black w-full px-2 py-5"
                  value={category}
